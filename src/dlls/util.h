...
inline const char* STRING(string_t offset) { return gpGlobals->pStringBase + (int)offset; }
inline string_t MAKE_STRING(const char *str) { return (int)str - (int)STRING(0); }
